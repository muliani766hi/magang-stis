        ...
        <>
            ...
            <SimpleGrid cols={{ base: 1, md: 2 }} spacing="lg" pos="relative">
                ...
                <Stack justify="flex-start">
                    <TextInput label="NIP" placeholder="NIP" readOnly value={data.pembimbingLapangan?.nip || ''} />
                    <TextInput label="Nama" placeholder="Nama" readOnly value={data.pembimbingLapangan?.nama || ''} />
