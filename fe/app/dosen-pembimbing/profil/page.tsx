...
import { getProfile, putNewPassword } from "@/utils/get-profile";
        ...
        <>
            ...
            <SimpleGrid cols={{ base: 1, md: 2 }} spacing="lg" pos="relative">
                ...
                <Stack justify="flex-start">
                    <TextInput label="NIP" placeholder="NIP" readOnly value={data.dosenPembimbingMagang?.nip || ''} />
                    <TextInput label="Nama" placeholder="Nama" readOnly value={data.dosenPembimbingMagang?.nama || ''} />
                    <TextInput label="Email" placeholder="Email" readOnly value={data.email || ''} />
                    <TextInput label="Prodi" placeholder="Prodi" readOnly value={data.dosenPembimbingMagang?.prodi || ''} />
