...
const BimbinganSkripsi = () => {
    ...
    return (
        <>
            <Text c="dimmed" mb="md">Perizinan Kegiatan Kampus</Text>
            ...
            <Modal
                ...
                title={<Text size="xl">Ajukan Perizinan Kegiatan Kampus</Text>}
                centered
                overlayProps={{
            ...
            >
                ...
                <form onSubmit={form.onSubmit(async (values) => {
                    ...
                    try {
                        ...
                        notifications.show({
                            title: 'Gagal mengajukan perizinan',
                    ...
                    <Stack gap="md">
                        <DateInput
                            ...
                            label="Tanggal"
                            description="Tanggal perizinan yang diajukan"
                            {...form.getInputProps('tanggal')} />

                        <Textarea
                            label="Keterangan"
                            description="Keterangan kegiatan yang dilakukan"
                            {...form.getInputProps('keterangan')} />

                        <Group justify='center' grow>
                            <TimeInput label="Waktu Mulai"
                                ref={ref}
                                leftSection={pickerControl}
                                {...form.getInputProps('jamMulai')} />
                            <TimeInput label="Waktu Selesai"
                                ref={ref2}
                                leftSection={pickerControl2}
                        ...
                        <Button type="button"
                            onClick={() => {
                                modals.openConfirmModal({
                                    ...
                                    children: (
                                        <Text size="sm">
                                            Apakah anda yakin ingin mengajukan perizinan?
                                        </Text>
                                    ),
