...
const getFileLaporan = async (laporan: string) => {
    ...
    try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/laporan-magang/download/${laporan}`, {
            method: 'GET',
            headers: {
...
const TableLaporan = ({ records, loading, fetchData }: { records: RecordLaporan[]; loading: boolean; fetchData: () => void }) => {
    // pagination
        ...
        <>
            <DataTable
                ...
                columns={[
                    ...
                    {
                        accessor: 'fileLaporan', title: 'File Laporan', textAlign: 'left',
                        render: (record) => (
                            // <Group>
                            //     <Text>{record.fileLaporan}</Text>
                            //     <ActionIcon
                            //         size="sm"
                            //         variant="subtle"
                            //         color="blue"
                            //         onClick={() => getLaporan(record.fileLaporan)}
                            //     >
                            ...
                            <Button
                                ...
                                color="blue"
                                onClick={() =>
                                    // window.open(`${process.env.NEXT_PUBLIC_API_URL}/laporan-magang/download/${record.fileLaporan}`, '_blank')
                                    getFileLaporan(record.fileLaporan)
        ...
        const FormComponent = () => {
            const form = useForm({
                initialValues: {
                    ...
                    fileLaporan: record.fileLaporan,
                ...
                <form onSubmit={form.onSubmit(async (values) => {
                    ...
                    <Stack>
                        ...
                        <TextInput
                            ...
                            label='File Laporan' {...form.getInputProps('fileLaporan')} />
