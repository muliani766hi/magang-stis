...
import { putAssignMahasiswaToPembimbing, putUnassignMahasiswaToPembimbing } from '@/utils/kelola-user/admin-satker';
...
import { ActionIcon, Button, Grid, GridCol, Group, MultiSelect, Pill, Stack, Text, TextInput } from '@mantine/core';
...
const TablePembimbingLapangan = ({ records, loading, fetchData, dataMahasiswa, dataMahasiswaFull, page, setPage, pageSize, setPageSize, totalRecords }: Props) => {
            ...
            return (
                <form onSubmit={form.onSubmit(async (values) => {
                    try {
                        ...
                        notifications.show({ title: 'Gagal', message: 'Data pembimbing lapangan gagal diubah', color: 'red' });
                    } finally {
...
export default TablePembimbingLapangan