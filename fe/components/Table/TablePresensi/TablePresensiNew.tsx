...
export function PresensiTable({ mahasiswaId }: { mahasiswaId?: number }) {
...
const TablePresensiNew = ({ records, loading }: { records: any, loading: boolean }) => {
    ...
    return (
        <><DataTable
            ...
            columns={[
                ...
                // {
                //     accessor: 'persentaseKehadiran',
                //     title: 'Presentase',
                //     render : ({persentaseKehadiran}) => `${persentaseKehadiran}%`
                // },
                {
                ...
                {
                    accessor: 'totalTerlambatA',
                    title: 'Terlambat A',
                },
                {
                    accessor: 'totalTerlambatB',
                    title: 'Terlambat B',
                },

                {
                    accessor: 'totalTerlambatC',
                    title: 'Terlambat C',
                },
                {
                    accessor: 'izinRawatInap',
                    title: 'Rawat Inap',
                },
                {
                    accessor: 'dispensasi',
...
export default TablePresensiNew