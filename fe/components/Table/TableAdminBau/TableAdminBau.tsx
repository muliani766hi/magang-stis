...
const TableAdminBau = ({ records, loading, fetchData }: { records: RecordPemlap[], loading: boolean, fetchData: () => void }) => {
    // // pagination
            ...
            return (
                <form onSubmit={form.onSubmit(async (values) => {
                    try {
                        ...
                        notifications.show({ title: 'Berhasil', message: 'Data Keuangan berhasil diubah', color: 'teal' });
                        closeModal(action);
                        fetchData();
                    } catch (error) {
                        console.error('Failed to update data', error);
                        notifications.show({ title: 'Gagal', message: 'Data Keuangan gagal diubah', color: 'red' });
                    } finally {
